...
var calc = function calc() {
  var persons = document.querySelectorAll('.counter-block-input')[0],
      ...
      daysSum,
      total = 0;
  totalValue.innerHTML = 0; // анимация цифр
    ...
    var getNum = function getNum(str) {
      getOneNum(str).then(function (res) {
        if (index == 0) {
          ...
          element.textContent = "".concat(res.slice(0, index)).concat(count);
        }
    ...
    form.addEventListener('submit', function (e) {
      ...
      var loadingPost = function loadingPost() {
        ...
        var count = 0,
          ...
          statusMessage.style.transform = "rotate(".concat(++count, "deg)");
...
var lightScroll = function lightScroll() {
...
var slider = function slider() {
  ...
  var showSlides = function showSlides(n) {
    ...
    slides.forEach(function (item) {
      ...
      item.style.transform = "translateX(".concat(-100 * (slideIndex - 1), "%)");
    });
